import {
  useColorMode
} from "./chunk-YEHQCOJA.js";
import {
  require_jsx_runtime
} from "./chunk-PMZ3ULIR.js";
import {
  mergeThemeOverride
} from "./chunk-SEHPLPTI.js";
import {
  css,
  cx,
  isStyleProp,
...
function createIcon(options) {
  ...
  const path = import_react15.Children.toArray(options.path);
  const Comp = forwardRef3((props, ref) => (0, import_jsx_runtime3.jsx)(Icon, { ref, viewBox, ...defaultProps, ...props, children: path.length ? path : (0, import_jsx_runtime3.jsx)("path", { fill: "currentColor", d: pathDefinition }) }));
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QY2VDAUQ.js.map
